...
import { Modal, View, Text, ScrollView, TouchableOpacity, RefreshControl, Animated, StyleSheet } from 'react-native';
import { BlurView } from 'expo-blur';
import { Ionicons } from '@expo/vector-icons';
import { formatDistanceToNow } from 'date-fns';
import { useNotifications } from '../../hooks/useNotifications';
import { LinearGradient } from 'expo-linear-gradient';
import { themeColors } from '../Form/themeColors';  
  ...
  return (
    ...
    >
      ...
      {notifications
        ...
        .map((item) => renderNotification(item, 'notification'))}
